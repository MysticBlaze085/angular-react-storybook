...
const StockPrice$1 = /*@__PURE__*/ proxyCustomElement(class StockPrice extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return StockPriceStyle0; }
}, [1, "stock-price", {
