...
const RhapSideDrawer$1 = /*@__PURE__*/ proxyCustomElement(class RhapSideDrawer extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RhapSideDrawerStyle0; }
}, [1, "rhap-side-drawer", {
        "htitle": [513],
        "opened": [1540],
        "showContactInfo": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["rhap-side-drawer"];
    components.forEach(tagName => { switch (tagName) {
        case "rhap-side-drawer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RhapSideDrawer$1);
            }
            break;
    } });
}

const RhapSideDrawer = RhapSideDrawer$1;
const defineCustomElement = defineCustomElement$1;

export { RhapSideDrawer, defineCustomElement };
